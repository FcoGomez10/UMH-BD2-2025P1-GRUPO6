...
----------------- Actualizar tabla de habitacion --------------------------
 ...
 /* delimiter //
drop procedure proyecto2.sp_habitacion_upd; */
...
call proyecto2.sp_cliente_upd (1, 'Gustavo', 'Ferrufino', 'Empresa B', 'Gerente General', 'Z123456', '1990/05/30', 'Americano', '9885-2587', '9885-2588', 'gferrufino@email.com', 1);
